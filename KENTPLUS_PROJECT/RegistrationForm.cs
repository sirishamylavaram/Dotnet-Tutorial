...
namespace KENTPLUS_PROJECT
{
    ...
    public partial class RegistrationForm : Form
    {
        ...
        private void btnregister_Click_1(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please fill in all the fields", "WaterGuardPro-RegistrationForm", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            else
            {
                try
                {
                    ...
                    {
                        MessageBox.Show("This email address is already registered. Please use a different email address.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    ...
                    SqlCommand cmd = new SqlCommand(@"insert into Admin ([email],[username],[password], [firstname], [lastname]) values ('" + txtEmail.Text + "','" + txtusername.Text + "','" + txtpassword.Text + "','" + txtFirstName.Text + "','" + txtLastName.Text + "','" + txtmobile.Text + "')", con);
                    con.Open();
                    cmd.ExecuteNonQuery();
                    ...
                    MessageBox.Show("WaterGuardPro :" + "Registration successful. Confirmation email sent.", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                ...
                {
                    MessageBox.Show("WaterGuardPro :" + ex.Message);
                }
            }
        }
        ...
        private void SendConfirmationEmail(string to, string fullName, string mobile, string address)
        {
            try
            {
                ...
                string body = $"Dear {fullName},\n" +
                    ...
                    $"**Thank you for choosing [ WaterGuardPro ]!**\n\n" 
                   ...
                   + $"-**Thank you once again for choosing [WaterGuardPro]. We are committed to providing you with clean and safe drinking water. If you have any further questions or concerns, don't hesitate to reach out.**\n\n" 

                    + $"**Best Regards,\n\n"
                   + $"[WaterGuardPro]\n\n" 
                   + $"[WaterGuardPro Contact Information :1800-001-896]";

                message.Body = body;
                message.Subject = "Welcome to [WaterGuardPro] - Water Purifier Registration Successful!";
